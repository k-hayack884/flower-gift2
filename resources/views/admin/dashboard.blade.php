          ...
          <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div class="p-4 md:w-1/2 flex">
              <div class="flex-grow pl-6">
                ...
                <a href="{{ route('admin.users.index')}}"  class="mt-3 text-indigo-500 inline-flex items-center text-right">Learn More
            ...
            <div class="p-4 md:w-1/2 flex">
              <div class="flex-grow pl-6">
                ...
                <a href="{{ route('admin.expired-users.index')}}" class="mt-3 text-indigo-500 inline-flex items-center">Learn More
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                  </svg>
                </a>
            ...
            <div class="p-4 md:w-1/2 flex">
              <div class="flex-grow pl-6">
                ...
                <a href="{{  route('admin.bads.product-index')}}"  class="mt-3 text-indigo-500 inline-flex items-center">Learn More
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                  </svg>
                </a>
            ...
            <div class="p-4 md:w-1/2 flex">
                <div class="flex-grow pl-6">
                  ...
                  <p class="leading-relaxed text-base">違反していると報告された商品確認、非公開処理の切り替えができます</p>
                  <a href="{{  route('admin.bads.comment-index')}}" class="mt-3 text-indigo-500 inline-flex items-center">Learn More
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                      <path d="M5 12h14M12 5l7 7-7 7"></path>
                    </svg>
                  </a>
