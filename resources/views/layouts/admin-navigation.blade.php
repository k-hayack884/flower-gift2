    ...
    <div class="max-w-7xl mx-auto ">
        <div class="flex justify-between h-16 bg-green-500">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md hover:text-gray-500 hover:bg-green-500 focus:outline-none focus:bg-gray-100 focus:bg-green-500 transition duration-150 ease-in-out">
