                                            ...
                                            <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div class=" absolute top-0 right-0">
                                                        <favorite-component :canFavorite="false"
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <p class="text-gray-900">
                                                        {{ $item->created_at->toDateString() }}に追加</p>
                                                </div>
                                            </div>
                                        @else
                                            <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                                                ...
                                                <div class="mt-4">
                                                    <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">
                                                        ...
                                                        <p class="mb-4 leading-relaxed">
                                                            現在の状態:@if ($item->product->status == \Constant::PRODUCT_LIST['sell'])
                                                        取引可能@elseif($item->product->status == \Constant::PRODUCT_LIST['transaction'])取引中@elseif($item->product->status == \Constant::PRODUCT_LIST['sold'])取引終了
                                                        @endif
                                                    </p>
                                                    <p class="text-gray-900">
                                                        {{ $item->created_at->toDateString() }}に追加</p>
