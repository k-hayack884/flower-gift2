    ...
    <body class="antialiased">
        ...
        <div class="lg:flex lg:justify-around">
            <div class="lg:flex items-center">
                 <select name="category" class="lg:mr-4">
                     <option value="0">すべての商品</opition>
                ...
                <div class="flex space-x-2 items-center">
                    <div><input name="keyword" class="w-full bg-gray-100 bg-opacity-50 rounded border border-black focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="キーワードを入力"></div>
                    <div><button type="submit" class="flex mx-auto  text-white bg-indigo-500 border-0 py-2 px-12 focus:outline-none hover:bg-indigo-600 rounded text-lg mx-4">検索する</button></div>
                </div>
            </div>
